...
LTetromino::LTetromino(IState* stateInstance):Tetromino(stateInstance)
{
	_maxRotations = 4;
	...
	first->push_back( CreateRow( _columns, 1, 0, 0, 0 ) );
	first->push_back( CreateRow( _columns, 1, 0, 0, 0 ) );
	...
	_spriteURL = "assets/Gameplay/Tetromino/L.png";
}
